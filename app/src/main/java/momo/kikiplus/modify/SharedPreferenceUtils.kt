...
object SharedPreferenceUtils {
    ...
    fun write(context: Context, key: String, value: Any?) {
        val editor = context.getSharedPreferences(ContextUtils.KEY_PREFER_NAME, Context.MODE_PRIVATE).edit()
        if (value is Int) {
    ...
    fun read(context: Context, key: String, type: Int): Any? {
        val sharedPref = context.getSharedPreferences(ContextUtils.KEY_PREFER_NAME, Context.MODE_PRIVATE)
        when (type) {
