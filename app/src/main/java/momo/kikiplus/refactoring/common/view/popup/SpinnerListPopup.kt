...
import momo.kikiplus.refactoring.kbucket.ui.view.adapter.SpinnerListAdapter
...
(
    ...
    /**
         * 레이아웃 리소스
         */
        private val m_Res: Int, popupReceive: IPopupReceive, popId: Int) : CustomPopup(mCotext, mTitle, m_Res, popupReceive, true, popId) {
