 ...
 * @since 2015. 1. 6.
 */
class UpdateListAdpater
/**
 * 생성자
 */
(context: Context, res: Int, list: ArrayList<UpdateApp>,
 /**
  * 클릭 리스너
  */
 private val mClickListener: View.OnClickListener) : BaseAdapter() {
     ...
     * 리스트 아이템
     */
    private var mListItem: ArrayList<UpdateApp>? = null
     ...
     * 데이타 리스트 변경 메소드
     */
    fun setDataList(list: ArrayList<UpdateApp>) {
        mListItem = list
