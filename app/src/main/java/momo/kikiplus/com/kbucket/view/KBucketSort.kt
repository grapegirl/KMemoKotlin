...
object KBucketSort {
    ...
    //날짜순 정렬
    var DATE_SORT: Comparator<Bucket> = Comparator { lhs, rhs -> DateUtils.getCompareDate(DateUtils.DATE_YYMMDD_PATTER, lhs.date!!, rhs.date!!) }

    //내용순 정렬
    var MEMO_SORT: Comparator<Bucket> = Comparator { lhs, rhs -> lhs.content!!.compareTo(rhs.content!!) }

    //기한순 정렬
    var DEADLINE_SORT: Comparator<Bucket> = Comparator { lhs, rhs ->
