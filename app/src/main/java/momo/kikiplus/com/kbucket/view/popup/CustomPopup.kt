 ...
 * @param contentView
 */
(context: Context, title: String, contentView: Int, popupEventListener: OnPopupEventListener, isCancle: Boolean,
 /**
  * 다이얼로그 구분 값
  */
 protected var mPopId: Int) : View.OnClickListener, DialogInterface.OnKeyListener {
    ...
    fun onPopupBackPressed() {
        ...
        if (mCancleable) {
            mPopupEventListener!!.onPopupAction(mPopId, OnPopupEventListener.POPUP_BACK, null)
        } else {
