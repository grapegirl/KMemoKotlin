...
object SharedPreferenceUtils {
    ...
    /**프레퍼런스 integer 타입 */
    const val SHARED_PREF_VALUE_INTEGER = 0

    /**프레퍼런스 float 타입 */
    private const val SHARED_PREF_VALUE_FLOAT = 1

    /**프레퍼런스 long 타입 */
    private const val SHARED_PREF_VALUE_LONG = 2

    /**프레퍼런스 string 타입 */
    const val SHARED_PREF_VALUE_STRING = 3

    /**프레퍼런스 boolean 타입 */
    private const val SHARED_PREF_VALUE_BOOLEAN = 4

    /**
     * 프리퍼런스 이름
     */
    private const val KEY_PREFER_NAME = "APP_PREFER_NAME"
