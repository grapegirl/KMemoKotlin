...
object MediaUtils {
     ...
     */
    public fun showPdfFile(context: Context, strPdfFile: String) {
        try {
     ...
     * @param nAudio  오티오
     */
    public fun onAudioPlay(context: Context, nAudio: Int) {
        try {
            ...
            mediaPlayer.setOnSeekCompleteListener { mp -> mp.stop() }
            mediaPlayer.start()
        } catch (e: Exception) {
            e.printStackTrace()
        }
